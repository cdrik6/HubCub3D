...
/*   Updated: 2024/10/03 00:36:20 by caguillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// use: print_mat((*map).tab); to check the map (to be de_commented before)
...
// is well closed too
// use: print_mat(trans); to check the tranpose (to be de_commented before)
